...
const __2___ = (() => {
  class Proxy {
    ...
    constructor(
      maxHttpQueries,
      maxHttpQueryDurationMs,
      maxHttpQueryUrlLength,
      maxHttpQueryRequestBytes,
      maxHttpQueryResponseBytes,
      port,
    ) {
      this.maxHttpQueries = maxHttpQueries
      this.maxHttpQueryDurationMs = maxHttpQueryDurationMs
      this.maxHttpQueryUrlLength = maxHttpQueryUrlLength
      this.maxHttpQueryRequestBytes = maxHttpQueryRequestBytes
      this.maxHttpQueryResponseBytes = maxHttpQueryResponseBytes
      this.port = port
    ...
    handleHttpConnection = async (httpConn) => {
    ...
    handleProxyRequest = async (requestEvent) => {
      let proxyRequestTimeout
      try {
        this.httpQueryCount++
